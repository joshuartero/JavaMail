...
public class JD_Buscar_DNI extends javax.swing.JDialog {
    ...
    JIF_Registrar_Trabajador jifrt;
    
    public JD_Buscar_DNI(JIF_Registrar_Trabajador jifrt, boolean modal) {
        super(JOptionPane.getFrameForComponent(jifrt), modal);
        this.jifrt=jifrt;
        initComponents();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        dispose();
        jifrt.jTextField2.setText(""+jTable1.getValueAt(jTable1.getSelectedRow(), 0));
