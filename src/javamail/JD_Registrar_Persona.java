...
public class JD_Registrar_Persona extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(!camposNoVacios())
        {   int opc=JOptionPane.showConfirmDialog(this, "Desea Registrar Esta Persona?", "CONFIRMAR REGISTRO", JOptionPane.YES_NO_OPTION);
    ...
    {   boolean vacios=false;
        ...
        {   JOptionPane.showMessageDialog(this, "Porfavor Ingrese Nombres");
            jTextField2.requestFocus();
            vacios=true;
        }
        else if(jTextField3.getText().length()==0)
        {   JOptionPane.showMessageDialog(this, "Porfavor Ingrese Apellido Paterno");
            jTextField3.requestFocus();
            vacios=true;
        }
        else if(jTextField4.getText().length()==0)
        {   JOptionPane.showMessageDialog(this, "Porfavor Ingrese Apellido Materno");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JD_Registrar_Persona.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JD_Registrar_Persona dialog = new JD_Registrar_Persona(new javax.swing.JFrame(), true);
