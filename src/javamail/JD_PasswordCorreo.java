 ...
 * @author Joshua
 */
public class JD_PasswordCorreo extends javax.swing.JDialog {
    ...
    public JD_PasswordCorreo(MDI_Principal mdip, boolean modal) {
        super(JOptionPane.getFrameForComponent(mdip), modal);
        this.mdip=mdip;
        initComponents();
    ...
    {   try
        {   st = (Statement) con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
            rs1=st.executeQuery("SELECT P.`APELLIDOP`, P.`APELLIDOM`, P.`NOMBRES` FROM Trabajador T INNER JOIN Persona P "
                + "ON T.`DNI`=P.`DNI` ORDER BY P.`APELLIDOP`;");
            while(rs1.next())
               modelo.addElement(rs1.getString(1)+" "+rs1.getString(2)+" "+rs1.getString(3));            
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        mdip.desktopPane.add(jifea);        
        jifea.setVisible(true);        
        jifea.password=jPasswordField1.getPassword();        
...
//        dispose();
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        String trabajador=(String)jComboBox1.getSelectedItem();
//        JOptionPane.showMessageDialog(this, trabajador);
        String correo=correoTrabajador(trabajador);
    ...
    {   String correo="";
        try
        {   st = (Statement) con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
            rs2=st.executeQuery("SELECT T.Correo FROM Trabajador T INNER JOIN Persona P ON T.`DNI`=P.`DNI`WHERE "
